 ...
 * @var iterable<\App\Model\Entity\Spenttype> $spenttypes
 */
...
<div class="mt-3">
    ...
    <?= $this->Html->link(__('Nouveau Spenttype'), ['action' => 'add'], ['class' => 'btn btn-success btn-sm mb-3']) ?>
    <div class="table-responsive">
        <table id="scroll-vertical" class="table table-bordered text-nowrap w-100 TableData">
            ...
            <tbody>
                <?php foreach ($spenttypes as $spenttype): ?>
                <tr>
                    <td><?= $Number++ ?></td>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="NewItem"
    ...
    <div class="offcanvas-header border-bottom border-block-end-dashed">
        <h5 class="offcanvas-title" id="offcanvasRightLabel1">Nouveau Spenttypes</h5>
...
<script>
    $(document).ready(function() {
        $('#DataForm').on('submit', function(e) {
            ...
            $.ajax({
                url: '<?= $this->Url->build(["controller" => 'Spenttypes', 'action' => 'insert']) ?>',
                method: 'POST',
                data: formData,
