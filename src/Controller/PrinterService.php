...
class PrinterService
{
    ...
    public function printLabel(array $products): void
    {
        try {
            $handle = $this->getHandle();
            ...
            $this->formatText("No. RCCM : KWZ/RCCM/24-A-00200\n", ['center', 'font_b']);
            $this->formatText("ID NAT : 14-G4701-N68656N\n", ['center', 'font_b']);
            $this->formatText("No. IMPOT : A2435655N\n", ['center', 'font_b']);
            $this->formatText("MARCHE LUILU EN FACE DU CERCLE\n", ['center', 'font_b']);
            $this->formatText("C. DILALA, V. KOLWEZI, P. LUALABA\n", ['center', 'font_b']);
            $this->formatText("-----------------------------------------------\n", ['center']);

            // Store information
            $this->formatText("Caissier: John Doe\n", ['left', 'font_b']);
            $this->formatText("Date: " . date('Y-m-d H:i:s') . "\n", ['left', 'font_b']);
            $this->formatText("Facture #12345\n\n", ['left', 'font_b']);
            ...
            $this->formatText("Nom: Antoine de Padoue\n", ['left', 'font_b']);
            $this->formatText("Telephone: 243823777333\n", ['left', 'font_b']);
            $this->formatText("-----------------------------------------------\n", ['left']);
            ...
            echo "Itemized receipt printed successfully!";
        } finally {
            $this->closeHandle();
        }
    }
